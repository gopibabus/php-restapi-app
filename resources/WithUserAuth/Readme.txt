...
Under file to import click the choose file and select the file tasksdb_withuser.sql under the SQL folder.
Then Click Go
The new tasksdb folder should now have been created.
